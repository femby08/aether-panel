...
const propDesc = { 'online-mode': 'ACTIVADO: Solo cuentas Premium.\nDESACTIVADO: Permite No-Premium (Crackeado).', 'motd': 'Mensaje debajo del nombre del servidor.', 'max-players': 'Límite de jugadores.', 'server-port': 'Puerto del servidor (25565).', 'white-list': 'Solo usuarios en lista blanca pueden entrar.', 'pvp': 'Daño entre jugadores.', 'allow-flight': 'Permite volar en survival (anti-kick).', 'view-distance': 'Distancia de renderizado (chunks).', 'difficulty': 'peaceful, easy, normal, hard.', 'gamemode': 'survival, creative, adventure, spectator.', 'level-seed': 'Semilla del mundo.', 'spawn-protection': 'Radio protegido en el spawn.', 'hardcore': 'Ban al morir.', 'enable-command-block': 'Permitir bloques de comandos.' };
function loadCfg() { 
    ...
    }).catch(e => console.error("Error cargando settings globales:", e));
}
